...
/**
 * Servlet implementation class CheckShows
 */
@WebServlet("/CheckShows")
public class CheckShows extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// PrintWriter outp_print = response.getWriter();
		    ...
		    ResultSet res = obj_show.check_shows();
...
//						        	return 0;
						  ...
						  //   outp_print.println("<center>");
						   ...
						   //  outp_print.println("<p>"+res.getString("theater_name")+"</p>");
						     ...
						     outp_print.println("<a href='check_availablity?id="+res.getInt("showid")+"'><button type='button'>check availablity</button></a>");
						...
						System.out.println("cant' get shows from shows_table");
						e.printStackTrace();
					}
					
					if(flag==0)
					{
						outp_print.println("<h1 id='error'>No shows avialable</h1>");
